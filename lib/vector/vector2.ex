defmodule Vector.Vector2 do
  ...
  iex> Vector.Vector2.from_tuple({1.0, 1.5})
  %Vector.Vector2{x: 1.0, y: 1.5}
  """
  ...
  iex> Vector.Vector2.right_normal(%Vector.Vector2{x: 3.0, y: 4.0})
  %Vector.Vector2{x: -4.0, y: 3.0}
  """
  ...
  iex> Vector.Vector2.left_normal(%Vector.Vector2{x: 3.0, y: 4.0})
  %Vector.Vector2{x: 4.0, y: -3.0}
  """
  ...
  iex> Vector.Vector2.per_product(%Vector.Vector2{x: 3.0, y: 4.0}, %Vector.Vector2{x: -1.0, y: 2.0})
  -10.0
  """
